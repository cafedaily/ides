...
- DEV-d87c893d9908 [done]: # T-003: Public deployment authentication and secret handling
...
- DEV-4e0ca6f5e5ca [done]: # T-001: Real SSE streaming and cancellation
...
- DEV-local-space [done]: Local personal space with user-owned models and guided settings
